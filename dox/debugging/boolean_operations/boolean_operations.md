...
@figure{/debug/boolean_operations/images/operations_image001.svg,  "Operators"}
...
@figure{/debug/boolean_operations/images/operations_image002.svg,  "Vertex/vertex interference"}
...
@figure{/debug/boolean_operations/images/operations_image003.svg,  "Vertex/edge interference"}
...
@figure{/debug/boolean_operations/images/operations_image004.svg,  "Vertex/face interference"}
...
@figure{/debug/boolean_operations/images/operations_image005.svg,  "Edge/edge interference: common parts"}
...
@image html /debug/boolean_operations/images/operations_image006.svg  "Edge/edge interference: common points"
@image latex /debug/boolean_operations/images/operations_image006.svg  "Edge/edge interference: common points"
...
@figure{/debug/boolean_operations/images/operations_image007.svg, "Edge/face interference: common parts"}
...
@figure{/debug/boolean_operations/images/operations_image008.svg,  "Edge/face interference: common points"}
...
@figure{/debug/boolean_operations/images/operations_image009.svg,  "Face/face interference: common curves"}
...
@figure{/debug/boolean_operations/images/operations_image010.svg, "Face/face interference: common points"}
...
@figure{/debug/boolean_operations/images/operations_image060.png,  "Vertex/Solid Interference"}
...
@figure{/debug/boolean_operations/images/operations_image061.png,  "Edge/Solid Interference"}
...
@figure{/debug/boolean_operations/images/operations_image062.png,  "Face/Solid Interference"} 
...
@figure{/debug/boolean_operations/images/operations_image063.png,  "Solid/Solid Interference"} 
...
@figure{/debug/boolean_operations/images/operations_image011.svg,  "Paves"}
...
@figure{/debug/boolean_operations/images/operations_image012.svg, "Pave Blocks"}
...
@figure{/debug/boolean_operations/images/operations_image013.svg, "Shrunk Range"}
...
@figure{/debug/boolean_operations/images/operations_image014.svg, "Common Blocks: Edge/Edge interference"}
...
@figure{/debug/boolean_operations/images/operations_image015.svg, "Common Blocks: Edge/Face interference"}
...
@figure{/debug/boolean_operations/images/operations_image016.svg,  "Face Info"}
...
@figure{/debug/boolean_operations/images/operations_image017.svg,  "BOPDS_Interf classes"}
...
@figure{/debug/boolean_operations/images/operations_image064.svg,  "Diagram for Class BOPAlgo_PaveFiller"}
...
@figure{/debug/boolean_operations/images/operations_image018.svg, "Connexity chains of interfered vertices"}
...
@figure{/debug/boolean_operations/images/operations_image019.png,  "Coinciding chains of pave blocks"}
...
@figure{/debug/boolean_operations/images/operations_image020.svg, "Diagram for BP classes"}
...
@figure{/debug/boolean_operations/images/operations_image021.svg, "Three Intersecting Edges"}
...
@figure{/debug/boolean_operations/images/operations_image022.svg,  "Two wires and an edge"}
...
@figure{/debug/boolean_operations/images/operations_image023.svg,  "An edge intersecting with a face"}
...
@figure{/debug/boolean_operations/images/operations_image024.svg,  "An edge lying on a face"}
...
@figure{/debug/boolean_operations/images/operations_image025.svg, "An edge and a shell"}
...
@figure{/debug/boolean_operations/images/operations_image026.svg,  "A wire and a shell"}
...
Let us consider 3 faces: *F1, F2* and *F3*. @figure{/debug/boolean_operations/images/operations_image027.png,  "Three faces"}
...
@figure{/debug/boolean_operations/images/operations_image028.png,  "A face and a shell"}
...
Let us consider shell *Sh1 (F11, F12…F16)* and solid *So2*. @figure{/debug/boolean_operations/images/operations_image029.png,  "A shell and a solid: arguments"}

The result of the GF operation is a compound consisting of 2 shapes:
* Image shell *Sh11* consisting of split face parts of *Sh1: Fn1, Fn2 ... Fn8.*
* Solid *So21* with internal shell. (image of *So2*).
@figure{/debug/boolean_operations/images/operations_image030.png,  "A shell and a solid: results"}
...
@figure{/debug/boolean_operations/images/operations_image031.png, "A compound and a solid: arguments"}
...
@figure{/debug/boolean_operations/images/operations_image032.png, "A compound and a solid: results"}
...
@figure{/debug/boolean_operations/images/operations_image033.svg,  "Chains of same domain faces"}
...
@figure{/debug/boolean_operations/images/boolean_image001.svg}

* The result of *Fuse* operation is the compound that contains new vertex *V*.

@figure{/debug/boolean_operations/images/boolean_image002.svg}
...
@figure{/debug/boolean_operations/images/boolean_image004.png}
...
@figure{/debug/boolean_operations/images/boolean_image005.png}
...
@figure{/debug/boolean_operations/images/boolean_image006.png}
...
@figure{/debug/boolean_operations/images/boolean_image007.png}
...
@figure{/debug/boolean_operations/images/boolean_image008.png}
...
@figure{/debug/boolean_operations/images/boolean_image009.png}
...
@figure{/debug/boolean_operations/images/boolean_image010.svg}
...
@figure{/debug/boolean_operations/images/boolean_image011.svg}	
...
@figure{/debug/boolean_operations/images/boolean_image012.svg}	
...
@figure{/debug/boolean_operations/images/boolean_image013.svg}	
...
@figure{/debug/boolean_operations/images/boolean_image014.svg}
...
@figure{/debug/boolean_operations/images/boolean_image015.svg}	
...
@figure{/debug/boolean_operations/images/boolean_image019.png}
...
@figure{/debug/boolean_operations/images/boolean_image020.png}	
...
@figure{/debug/boolean_operations/images/boolean_image021.png}
...
@figure{/debug/boolean_operations/images/boolean_image022.png}
...
@figure{/debug/boolean_operations/images/boolean_image023.png}	
...
@figure{/debug/boolean_operations/images/boolean_image024.png}
...
@figure{/debug/boolean_operations/images/boolean_image025.png}
...
@figure{/debug/boolean_operations/images/boolean_image071.png}	
...
@figure{/debug/boolean_operations/images/boolean_image072.png}
...
@figure{/debug/boolean_operations/images/boolean_image073.png}

* The result of *Cut12* operation is a compound containing split part of the argument *E1*, i.e. new edge *E11*.  

In this case the argument edge *E1* has a common part with solid *S2* so the corresponding part is not included into the result. The yellow square is not a part of the result. It only shows the place of *S2*.

@figure{/debug/boolean_operations/images/boolean_image026.png}	
...
@figure{/debug/boolean_operations/images/boolean_image027.png}
...
@figure{/debug/boolean_operations/images/boolean_image028.png}
...
@figure{/debug/boolean_operations/images/boolean_image029.png}	

* The result of *Cut21* operation is a compound containing split parts of the argument  *F2*, i.e. 1 new face *F21*.

@figure{/debug/boolean_operations/images/boolean_image030.png}
...
@figure{/debug/boolean_operations/images/boolean_image031.png}
...
@figure{/debug/boolean_operations/images/boolean_image032.png}
...
@figure{/debug/boolean_operations/images/boolean_image033.png}

* The result of *Cut12* operation is a compound containing split part of the argument *F1*, i.e. new face *F11*.  
	
@figure{/debug/boolean_operations/images/boolean_image034.png}	
	
* The result of *Cut21* operation is a compound containing split parts of the argument  *F2*, i.e. 1 new face *F21*.

@figure{/debug/boolean_operations/images/boolean_image035.png}
...
@figure{/debug/boolean_operations/images/boolean_image036.png}

* The result of *Fuse* operation is a compound containing split parts of arguments, i.e. 2 new faces: *F11* and *F21*. These faces have one shared edge *En1*.
	
@figure{/debug/boolean_operations/images/boolean_image037.png}
...
@figure{/debug/boolean_operations/images/boolean_image038.png}	
...
@figure{/debug/boolean_operations/images/boolean_image039.png}
...
@figure{/debug/boolean_operations/images/boolean_image040.png}
...
@figure{/debug/boolean_operations/images/boolean_image041.png}
...
@figure{/debug/boolean_operations/images/boolean_image042.png}	
	
* The result of *Cut21* operation is a compound containing split parts of the argument  *F2*, i.e. 1 new face *F21*. 

@figure{/debug/boolean_operations/images/boolean_image043.png}
...
@figure{/debug/boolean_operations/images/boolean_image044.png}
...
@figure{/debug/boolean_operations/images/boolean_image045.png}
...
@figure{/debug/boolean_operations/images/boolean_image046.png}	
...
@figure{/debug/boolean_operations/images/boolean_image047.png}
...
@figure{/debug/boolean_operations/images/boolean_image048.png}

* The result of *Cut12* operation is a compound containing split part of the argument *F1*. In this case  argument face *F1* has a common part with solid *S2* so the corresponding part is not included into the result. The yellow contour is not a part of the result. It only shows the place of *S2*.
  	
@figure{/debug/boolean_operations/images/boolean_image049.png}	
...
@figure{/debug/boolean_operations/images/boolean_image050.png}
...
@figure{/debug/boolean_operations/images/boolean_image051.png}	
...
@figure{/debug/boolean_operations/images/boolean_image052.png}
...
@figure{/debug/boolean_operations/images/boolean_image053.png}	
...
@figure{/debug/boolean_operations/images/boolean_image054.png}
...
@figure{/debug/boolean_operations/images/boolean_image055.png}	
...
@figure{/debug/boolean_operations/images/boolean_image059.png}

* The result of *Fuse* operation is a compound composed from the split parts of arguments *S11, S12* and *S22* <i>(Cut12, Common, Cut21)</i>. All inner webs are removed, so the result is one new solid *R*. 
	
@figure{/debug/boolean_operations/images/boolean_image060.png}	
...
@figure{/debug/boolean_operations/images/boolean_image061.png}	
	
* The result of *Cut21* operation is a compound containing split part of the argument *S2*, i.e. 1 new solid *S21*.
@figure{/debug/boolean_operations/images/boolean_image062.png}
...
@figure{/debug/boolean_operations/images/boolean_image063.png}
...
@figure{/debug/boolean_operations/images/boolean_image064.png}	
...
@figure{/debug/boolean_operations/images/boolean_image065.png}	
...
@figure{/debug/boolean_operations/images/boolean_image066.png}
...
@figure{/debug/boolean_operations/images/boolean_image067.png}
...
@figure{/debug/boolean_operations/images/boolean_image068.png}	
...
@figure{/debug/boolean_operations/images/boolean_image069.png}	
	
* The result of *Cut21* operation is a  compound containing split part of the argument *S2*. 

@figure{/debug/boolean_operations/images/boolean_image070.png}
...
@figure{/debug/boolean_operations/images/boolean_image136.png}
...
@figure{/debug/boolean_operations/images/boolean_image137.png}	
...
@figure{/debug/boolean_operations/images/boolean_image138.png}	
...
@figure{/debug/boolean_operations/images/boolean_image139.png}
...
@figure{/debug/boolean_operations/images/boolean_image140.png}
...
@figure{/debug/boolean_operations/images/boolean_image141.png}	
...
@figure{/debug/boolean_operations/images/boolean_image142.png}	
...
@figure{/debug/boolean_operations/images/boolean_image143.png}	
...
@figure{/debug/boolean_operations/images/boolean_image080.png}

The result of *Section* operation is the compound that contains a new vertex *V*.

@figure{/debug/boolean_operations/images/boolean_image081.png}

@subsubsection occt_algorithms_10a_3_2 Case 1: Case 2: A Vertex and an Edge

Let us consider vertex *V1* and the edge *E2*, that intersect in a 3D point:

@figure{/debug/boolean_operations/images/boolean_image082.png}

The result of *Section* operation is the compound that contains vertex *V1*.

@figure{/debug/boolean_operations/images/boolean_image083.png}

@subsubsection occt_algorithms_10a_3_3 Case 1: Case 2: A Vertex and a Face
 
Let us consider vertex *V1* and face *F2*, that intersect in a 3D point:

@figure{/debug/boolean_operations/images/boolean_image084.png}

The result of *Section* operation is the compound that contains vertex *V1*.

@figure{/debug/boolean_operations/images/boolean_image085.png}
...
@figure{/debug/boolean_operations/images/boolean_image086.png}
...
@figure{/debug/boolean_operations/images/boolean_image095.png} 

The result of *Section* operation is the compound that contains a new vertex *Vnew*. 

@figure{/debug/boolean_operations/images/boolean_image096.png}
...
@figure{/debug/boolean_operations/images/boolean_image097.png}
 
The result of *Section* operation is the compound that contains a new edge *Enew*. 

@figure{/debug/boolean_operations/images/boolean_image098.png}
 
@subsubsection occt_algorithms_10a_3_11 Case 11: Two intersecting faces

Let us consider two intersecting faces *F1* and *F2*:
 
@figure{/debug/boolean_operations/images/boolean_image099.png}

The result of *Section* operation is the compound that contains a new edge *Enew*. 

@figure{/debug/boolean_operations/images/boolean_image100.png}
 
@subsubsection occt_algorithms_10a_3_12 Case 12: Two faces that have a common part

Let us consider two faces *F1* and *F2* that have a common part:

@figure{/debug/boolean_operations/images/boolean_image133.png}
 
The result of *Section* operation is the compound that contains 4 new edges.

@figure{/debug/boolean_operations/images/boolean_image134.png}
...
@figure{/debug/boolean_operations/images/boolean_image101.png}

The result of *Section* operation is the compound that contains a new edge *Enew*.

@figure{/debug/boolean_operations/images/boolean_image102.png}
...
@figure{/debug/boolean_operations/images/boolean_image103.png}
 
The result of *Section* operation is the compound that contains a new vertex *Vnew*. 
 
@figure{/debug/boolean_operations/images/boolean_image104.png}
...
@figure{/debug/boolean_operations/images/boolean_image105.png}
 
The result of *Section* operation is the compound that contains new edges.

@figure{/debug/boolean_operations/images/boolean_image106.png}
...
@figure{/debug/boolean_operations/images/boolean_image107.png}
 
The result of *Section* operation is the compound that contains new edges
 
@figure{/debug/boolean_operations/images/boolean_image108.png}
...
@figure{/debug/boolean_operations/images/boolean_image109.png} 

The result of *Section* operation is the compound that contains a new edge *Enew*.

@figure{/debug/boolean_operations/images/boolean_image110.png}
...
@figure{/debug/boolean_operations/images/boolean_image111.png}
  
The result of *Section* operation is the compound that contains a new vertex *Vnew*.
 
@figure{/debug/boolean_operations/images/boolean_image112.png}

@subsubsection occt_algorithms_10a_3_19 Case 19: Two intersecting Solids

Let us consider two intersecting solids *Z1* and *Z2*:
@figure{/debug/boolean_operations/images/boolean_image113.png} 

The result of *Section* operation is the compound that contains new edges.
@figure{/debug/boolean_operations/images/boolean_image114.png} 
...
@figure{/debug/boolean_operations/images/boolean_image115.png} 

The result of *Section* operation is the compound that contains new edges.
@figure{/debug/boolean_operations/images/boolean_image116.png} 
...
@figure{/debug/boolean_operations/images/boolean_image117.png}
 
The result of *Section* operation is the compound that contains a new edge *Enew*.
@figure{/debug/boolean_operations/images/boolean_image118.png} 
...
@figure{/debug/boolean_operations/images/boolean_image119.png} 

The result of *Section* operation is the compound that contains a new vertex *Vnew*.
@figure{/debug/boolean_operations/images/boolean_image120.png} 
...
@figure{/debug/boolean_operations/images/operations_image036.svg, "Compound of two edges"}

#### Example 2: Self-interfered Edge
The edge *E* is a self-interfered shape and cannot be used as an argument of the Algorithms.

@figure{/debug/boolean_operations/images/operations_image037.svg, "Self-interfered Edge"}
 
#### Example 3: Self-interfered Face
The face *F* is a self-interfered shape and cannot be used as an argument of the Algorithms.

@figure{/debug/boolean_operations/images/operations_image038.svg, "Self-interfered Face"}
 
####	Example 4: Face of Revolution
The face *F* has been obtained by revolution of edge *E* around line *L*.

@figure{/debug/boolean_operations/images/operations_image039a.png, "Face of Revolution: Arguments"} 
@figure{/debug/boolean_operations/images/operations_image039b.png, "Face of Revolution: Result"} 
...
Let us consider edge *E* based on a non-closed circle. @figure{/debug/boolean_operations/images/operations_image040.png, "Edge based on a non-closed circle"}

The distance between the vertices of *E* is *D=0.69799*. The values of the tolerances *Tol(V1)=Tol(V2)=0.5*.
@figure{/debug/boolean_operations/images/operations_image041.png,  "Distance and Tolerances"}
...
Let us consider solid *S* containing vertex V. @figure{/debug/boolean_operations/images/operations_image042.png,  "Solid containing an interfered vertex"}

The value of  tolerance Tol(V)= 50.000075982061.

@figure{/debug/boolean_operations/images/operations_image043.png,  "Tolerance"}
...
@figure{/debug/boolean_operations/images/boolean_image135.png}
...
@figure{/debug/boolean_operations/images/operations_image044.png, "Face 1"}

@figure{/debug/boolean_operations/images/operations_image045.png, "P-Curves for Face 1"}
...
@figure{/debug/boolean_operations/images/operations_image046.png, "Face 2"}

@figure{/debug/boolean_operations/images/operations_image047.png, "P-Curves for Face 2"}
...
@figure{/debug/boolean_operations/images/operations_image048.png, "Example"}
...
@figure{/debug/boolean_operations/images/operations_image049.png, "Intersecting Edges"} 
...
@figure{/debug/boolean_operations/images/operations_image050.svg, "Intersecting Faces"} 
...
@figure{/debug/boolean_operations/images/operations_image051.svg, "Intersecting Edges"} 
...
@figure{/debug/boolean_operations/images/operations_image052.svg, "Result of Intersection"} 
...
@figure{/debug/boolean_operations/images/operations_image053.svg, "Intersecting Faces"} 
...
@figure{/debug/boolean_operations/images/operations_image054.svg, "Vertex and Edge"} 
...
@figure{/debug/boolean_operations/images/operations_image055.svg, "Vertex and Wire"} 
...
@figure{/debug/boolean_operations/images/boolean_image121.png} 
  
The following results are obtained using Basic Operations and the Fuzzy ones with the fuzzy value 5e<sup>-5</sup>:

@figure{/debug/boolean_operations/images/boolean_image122.png, "Result of CUT operation obtained with Basic Operations"} 

@figure{/debug/boolean_operations/images/boolean_image123.png, "Result of CUT operation obtained with Fuzzy Option"} 
...
@figure{/debug/boolean_operations/images/boolean_image124.png} 

The following results are obtained using Basic Operations and the Fuzzy ones with the fuzzy value 1e<sup>-6</sup>: 

@figure{/debug/boolean_operations/images/boolean_image125.png, "Result of CUT operation obtained with Basic Operations"} 

@figure{/debug/boolean_operations/images/boolean_image126.png, "Result of CUT operation obtained with Fuzzy Option"} 
...
@figure{/debug/boolean_operations/images/boolean_image127.png} 

The following results are obtained using Basic Operations and the Fuzzy ones with the fuzzy value 1e<sup>-5</sup>: 

@figure{/debug/boolean_operations/images/boolean_image128.png, "Result of CUT operation obtained with Basic Operations"} 

@figure{/debug/boolean_operations/images/boolean_image129.png, "Result of CUT operation obtained with Fuzzy Option"} 
...
@figure{/debug/boolean_operations/images/boolean_image130.png} 

The following results are obtained using Basic Operations and the Fuzzy ones with the fuzzy value 6e<sup>-5</sup>: 

@figure{/debug/boolean_operations/images/boolean_image131.png, "Result of CUT operation obtained with Basic Operations"} 

@figure{/debug/boolean_operations/images/boolean_image132.png, "Result of CUT operation obtained with Fuzzy Option"} 
...
@figure{/debug/boolean_operations/images/operations_image065.svg, "Diagram of BRepAlgoAPI package"} 
