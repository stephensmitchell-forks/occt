Git Guide for OCCT Development {#contribution__git_guide}
==============================
...
@note The repository is tested to work with Git 1.7.6 to 1.7.9. Please do not use versions below 1.7.1 as they are known to cause troubles.

@section gitguide_url Git URL
...
@section gitguide_content Content
...
@section gitguide_rules Rules of Use
...
@section gitguide_install Installing Tools

@subsection gitguide_install_win Windows
...
@subsection gitguide_install_linux Linux
...
@section gitguide_access Getting Access to Repository

  Access to the repository is granted to the users who have signed the
 <a href="http://dev.opencascade.org/sites/default/files/documents/Contributor_License_Agreement.pdf">
...
@subsection gitguide_keygen How to generate a key
...
@subsection gitguide_keyadd Adding Public Key in Account
...
@section gitguide_devs Work with Repository: Developer operations

@subsection gitguide_devs_general General workflow
...
@subsection gitguide_devs_clone Cloning Official Repository
...
@subsection gitguide_devs_branch_create Branch Creation
...
@subsection gitguide_devs_branch_switch Branch Switching
...
@subsection gitguide_branch_commit Committing Branch Changes
...
@subsection gitguide_devs_branch_push Pushing Branch
...
@subsection gitguide_devs_synch Synchronizing
...
@subsection gitguide_devs_apply Applying Fix Made on Older Version of OCCT
...
@subsection gitguide_devs_rebase Rebasing with History Clean-up
...
@section gitguide_revs Work with Repository: Reviewer Operations
...
**Review branch changes with TortoiseGit**
  ...
  * Fetch the changes from the remote repository as described in @ref gitguide_devs_synch section.   
