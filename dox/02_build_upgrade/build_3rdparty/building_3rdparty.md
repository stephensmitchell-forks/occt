...
5. If you build FreeType for a 64 bit platform, select in the main menu **Build - Configuration Manager**  and add *x64* platform to the solution configuration by copying the settings from Win32 platform: 
   ...
   @image html /02_build_upgrade/build_3rdparty/images/3rdparty_image001.png 
   @image latex /02_build_upgrade/build_3rdparty/images/3rdparty_image001.png 

   Update the value of the Output File for  x64 configuration: 

   @image html /02_build_upgrade/build_3rdparty/images/3rdparty_image003.png 
   @image latex /02_build_upgrade/build_3rdparty/images/3rdparty_image003.png 
...
4. Launch CMake <i>(cmake-gui.exe)</i> using  the Program menu. 
   ...
   * Press  **Configure** button. 
     ...
     @image html /02_build_upgrade/build_3rdparty/images/3rdparty_image004.png 
     @image latex /02_build_upgrade/build_3rdparty/images/3rdparty_image004.png 

   * Select the generator (the compiler  and the target platform -- 32 or 64 bit) in the pop-up window. 
   
     @image html /02_build_upgrade/build_3rdparty/images/3rdparty_image005.png 
     @image latex /02_build_upgrade/build_3rdparty/images/3rdparty_image005.png 
   ...
   * Press **Finish** button to  return to the main CMake window. 
     ...
     @image html /02_build_upgrade/build_3rdparty/images/3rdparty_image006.png 
     @image latex /02_build_upgrade/build_3rdparty/images/3rdparty_image006.png 
   ...
   * Expand the CMAKE group and define *CMAKE_INSTALL_PREFIX* which is the path where you want to install the build results, for example, *c:\\occ3rdparty\\gl2ps-1.3.5*. 
     ...
     @image html /02_build_upgrade/build_3rdparty/images/3rdparty_image007.png 
     @image latex /02_build_upgrade/build_3rdparty/images/3rdparty_image007.png 
