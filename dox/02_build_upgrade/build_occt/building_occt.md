...
@figure{/02_build_upgrade/build_3rdparty/images/genconf_windows.png}
...
@figure{/02_build_upgrade/build_occt/images/cmake_image000.png}
...
@figure{/02_build_upgrade/build_occt/images/cmake_image001.png}
...
@figure{/02_build_upgrade/build_occt/images/cmake_image002.png}
...
@figure{/02_build_upgrade/build_occt/images/cmake_image003.png}
...
| USE_VTK | Boolean flag | Indicates whether VTK 3rd party is used or not. VTK stands for Visualization ToolKit, the technology of Kitware Inc intended for general-purpose scientific visualization. OCCT comes with a bridge between CAD data representation and VTK by means of its dedicated VIS component (VTK Integration Services). You may skip this 3rd party unless you are planning to use VTK visualization for OCCT geometry. The official documentation @ref user_guides__visu_vis for the details on VIS |
...
@figure{/02_build_upgrade/build_occt/images/cmake_image004.png}
...
@figure{/02_build_upgrade/build_occt/images/android_image001.png}
...
Select "MinGW MakeFiles" item from the list
  ...
  - Click "Next"
@figure{/02_build_upgrade/build_occt/images/android_image002.png}

  - Specify a toolchain file at the next dialog by android.toolchain.cmake . It is contained by cross-compilation 
toolchain for CMake
  - Click "Finish"
@figure{/02_build_upgrade/build_occt/images/android_image003.png}
...
@figure{/02_build_upgrade/build_occt/images/android_image004.png}
...
@figure{/02_build_upgrade/build_occt/images/android_image005.png}
...
@figure{/02_build_upgrade/build_occt/images/android_image006.png}
...
@figure{/02_build_upgrade/build_3rdparty/images/genconf_osx.png}
...
@figure{/02_build_upgrade/build_3rdparty/images/genconf_linux.png}
