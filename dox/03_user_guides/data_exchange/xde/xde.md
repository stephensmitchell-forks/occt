Extended Data Exchange (XDE)  {#user_guides__data_exchange_xde}
============================
...
@figure{/03_user_guides/data_exchange/xde/images/646_xde_11_400.png,"Shape imported using XDE"}

The XDE component requires @ref user_guides__modeling_algos_shape_healing "Shape Healing" toolkit for operation. 
...
@image html /03_user_guides/data_exchange/xde/images/xde_image003.png "Assembly Description"
@image latex /03_user_guides/data_exchange/xde/images/xde_image003.png "Assembly Description"


@image html /03_user_guides/data_exchange/xde/images/xde_image004.png "Assembly View"
@image latex /03_user_guides/data_exchange/xde/images/xde_image004.png "Assembly View"
...
@image html /03_user_guides/data_exchange/xde/images/xde_image005.png "Validation Property Descriptions" 
@image latex /03_user_guides/data_exchange/xde/images/xde_image005.png "Validation Property Descriptions" 
...
@figure{/03_user_guides/data_exchange/xde/images/614_xde_04_400.png, "Instance Names"}
...
XDE can read and write colors and layers assigned to shapes or their subparts (down to the level of faces and edges) to and from both IGES and STEP formats. Three types of colors are defined in the enumeration *XCAFDoc_ColorType*: 
 ...
 @figure{/03_user_guides/data_exchange/xde/images/xde_image006.png, "Colors and Layers"}
...
@figure{/03_user_guides/data_exchange/xde/images/239_xde_12_400.png,"Motor Head"}
