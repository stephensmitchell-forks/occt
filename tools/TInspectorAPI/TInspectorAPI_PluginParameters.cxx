...
// =======================================================================
// function : SetImmediateUpdated
// purpose :
// =======================================================================
void TInspectorAPI_PluginParameters::SetImmediateUpdated(const TCollection_AsciiString& thePluginName,
                                                         const Standard_Boolean theToBeUpdated)
{
  if (theToBeUpdated && !myImmediateUpdatedPlugins.Contains (thePluginName))
    myImmediateUpdatedPlugins.Append (thePluginName);
  else if (!theToBeUpdated && myImmediateUpdatedPlugins.Contains (thePluginName))
    myImmediateUpdatedPlugins.Remove (thePluginName);
}
