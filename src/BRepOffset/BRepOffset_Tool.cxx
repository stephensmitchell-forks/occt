                   ...
                   TopTools_ListOfShape& theL2)
{
  ...
  TopoDS_Edge aE;
  {
    ...
    aBB.MakeEdge(aE, aC3D, aFF.TolReal());
    ...
    aBB.MakeVertex(aVF, aPF, aFF.TolReal());
    aBB.MakeVertex(aVL, aPL, aFF.TolReal());
    aVL.Orientation(TopAbs_REVERSED);
    // Add vertices to the edge
    aBB.Add(aE, aVF);
    aBB.Add(aE, aVL);
    // Add 2D curves to the edge
    aBB.UpdateEdge(aE, aIC.FirstCurve2d(), theFace1, aFF.TolReal());
    aBB.UpdateEdge(aE, aIC.SecondCurve2d(), theFace2, aFF.TolReal());
