...
void BRepMesh_FastDiscretFace::add(const Handle(BRepMesh_FaceAttribute)& theAttribute)
{
  ...
  Standard_Integer aCellsCountU = (Standard_Integer)Ceiling (Pow (2, Log10 ((myAttribute->GetUMax () - myAttribute->GetUMin ()) / myAttribute->GetDeltaX () / anErrFactorU)));
  Standard_Integer aCellsCountV = (Standard_Integer)Ceiling (Pow (2, Log10 ((myAttribute->GetVMax () - myAttribute->GetVMin ()) / myAttribute->GetDeltaY () / anErrFactorV)));
