...
public:
  ...
  //! Creates an algorithm to classify the point <theP> 
  //! relatively to the face from <theFE>.
  //! theTol3D is entered for compatibility with Geom2dHatch* classes.
  Standard_EXPORT BRepClass_FClassifier(BRepClass_FaceExplorer& theFE,
                                        const gp_Pnt2d& theP,
  ...
  //! relatively to the face from <theFE>.
  //! theTol3D is entered for compatibility with Geom2dHatch* classes.
  Standard_EXPORT void Perform(BRepClass_FaceExplorer& theFE,
                               const gp_Pnt2d& theP,
                               const Standard_Real theTol3D);
