...
protected:
  ...
  //! Creates geometrical representation of the topological
  //! edge theEdge and inserts it to myEList (if 
  //! theHasToBeAdded == TRUE).
  ...
  Standard_EXPORT Standard_Boolean
                    AddEdgeToList(const TopoDS_Edge &theEdge,
  ...
  //! Creates pseudo-edge and inserts it to myEList.
  //! Pseudo-edge is 2D-line, which joins thePFirst and thePLast
  //! points. This edge does not have any 3D- and topological-
  ...
  //! Created pseudo-dge will always have theOri orientation.
  Standard_EXPORT void AddPseudo(const gp_XY& thePFirst,
