...
public:
  ...
  Standard_EXPORT static 
    Standard_Integer ComputeVV (const TopoDS_Vertex& aV1, 
                                                     const gp_Pnt& aP2, 
  ...
  Standard_EXPORT static 
    Standard_Integer ComputeVV (const TopoDS_Vertex& aV1, 
                                ...
                                const Standard_Real theFuzz = 0.0);
  
  Standard_EXPORT static 
    void MakeVertex (BOPCol_ListOfShape& aLV, 
                     TopoDS_Vertex& aV);
  
  Standard_EXPORT static 
    void MakeEdge (const IntTools_Curve& theCurve, 
  ...
  Standard_EXPORT static 
    void MakePCurve (const TopoDS_Edge& theE, 
  ...
  Standard_EXPORT static 
    Standard_Boolean IsSplitToReverse (const TopoDS_Shape& theSplit, 
  ...
  //! theContext - cashed geometrical tools
  Standard_EXPORT static 
    Standard_Boolean IsSplitToReverse (const TopoDS_Face& theSplit, 
                                       const TopoDS_Face& theShape, 
                                       Handle(IntTools_Context)& theContext);
  
  Standard_EXPORT static 
    Standard_Boolean IsSplitToReverse (const TopoDS_Edge& aE1,
                                       const TopoDS_Edge& aE2, 
                                       Handle(IntTools_Context)& aContext);
  
  Standard_EXPORT static 
    Standard_Boolean AreFacesSameDomain (const TopoDS_Face& theF1,
                                         const TopoDS_Face& theF2, 
                                         Handle(IntTools_Context)& theContext,
                                         const Standard_Real theFuzz = 0.0);
  
  Standard_EXPORT static 
    Standard_Boolean CheckSameGeom (const TopoDS_Face& theF1, 
                                    const TopoDS_Face& theF2, 
                                    Handle(IntTools_Context)& theContext);
  
  Standard_EXPORT static 
    Standard_Integer Sense (const TopoDS_Face& theF1, 
                            const TopoDS_Face& theF2);
  ...
  //! edge founded
  Standard_EXPORT static 
    Standard_Boolean GetEdgeOff (const TopoDS_Edge& theEdge, 
  ...
  Standard_EXPORT static 
    Standard_Boolean GetFaceOff (const TopoDS_Edge& theEdge, 
                                 const TopoDS_Face& theFace, 
  ...
  Standard_EXPORT static 
    Standard_Integer IsInternalFace (const TopoDS_Face& theFace, 
  ...
  Standard_EXPORT static 
    Standard_Boolean GetEdgeOnFace (const TopoDS_Edge& theEdge, 
                                    const TopoDS_Face& theFace, 
  ...
  //! Returns 3-D state.
  Standard_EXPORT static 
    TopAbs_State ComputeState (const gp_Pnt& thePoint, 
                               const TopoDS_Solid& theSolid
                               , const Standard_Real theTol, 
                               Handle(IntTools_Context)& theContext);
  ...
  //! Returns 3-D state.
  Standard_EXPORT static 
    TopAbs_State ComputeState (const TopoDS_Vertex& theVertex,
                               const TopoDS_Solid& theSolid, 
                               const Standard_Real theTol, 
                               Handle(IntTools_Context)& theContext);
  ...
  //! Returns 3-D state.
  Standard_EXPORT static 
    TopAbs_State ComputeState (const TopoDS_Edge& theEdge, 
                               const TopoDS_Solid& theSolid, 
                               const Standard_Real theTol, 
                               Handle(IntTools_Context)& theContext);
  ...
  //! Returns 3-D state.
  Standard_EXPORT static 
    TopAbs_State ComputeState (const TopoDS_Face& theFace,
                               const TopoDS_Solid& theSolid,
                               const Standard_Real theTol, 
  ...
  //! Returns 3-D state.
  Standard_EXPORT static 
    TopAbs_State ComputeStateByOnePoint (const TopoDS_Shape& theShape, 
                                         const TopoDS_Solid& theSolid,
                                         const Standard_Real theTol, 
                                         Handle(IntTools_Context)& theContext);
  ...
  //! the treatment
  Standard_EXPORT static 
    void MakeConnexityBlock (BOPCol_ListOfShape& theLS, 
  ...
  Standard_EXPORT static 
    void MakeConnexityBlocks (const TopoDS_Shape& theS, 
                              const TopAbs_ShapeEnum theType1, 
                              const TopAbs_ShapeEnum theType2, 
                              BOPCol_ListOfShape& theLCB);
  
  Standard_EXPORT static 
    void OrientFacesOnShell (TopoDS_Shape& theS);
  ...
  //! perform.
  Standard_EXPORT static 
    void CorrectTolerances (const TopoDS_Shape& theS, 
  ...
  Standard_EXPORT static
    void CorrectCurveOnSurface (const TopoDS_Shape& theS, 
                                const Standard_Real theTolMax = 0.0001, 
                                const Standard_Boolean theRunParallel = Standard_False);
  ...
  Standard_EXPORT static 
    void CorrectPointOnCurve (const TopoDS_Shape& theS, 
                              const Standard_Real theTolMax = 0.0001,
                              const Standard_Boolean theRunParallel = Standard_False);
  ...
  Standard_EXPORT static 
    void MakeNewVertex (const gp_Pnt& aP1, 
  ...
  Standard_EXPORT static 
    void MakeNewVertex (const TopoDS_Vertex& aV1, 
                        const TopoDS_Vertex& aV2, 
                        TopoDS_Vertex& aNewVertex);
  ...
  Standard_EXPORT static 
    void MakeNewVertex (const TopoDS_Edge& aE1, 
  ...
  Standard_EXPORT static
    void PointOnEdge (const TopoDS_Edge& aEdge, 
  ...
  Standard_EXPORT static
    void MakeSplitEdge (const TopoDS_Edge& aE1, 
  ...
  //! at parameters <aP1,aP2>
  Standard_EXPORT static 
    void MakeSectEdge (const IntTools_Curve& aIC, 
                       const TopoDS_Vertex& aV1, 
                       const Standard_Real aP1,
                       const TopoDS_Vertex& aV2, 
                       const Standard_Real aP2, 
  ...
  //! the curve <aIC>
  Standard_EXPORT static
    void UpdateVertex (const IntTools_Curve& aIC,
  ...
  //! the edge <aE>
  Standard_EXPORT static 
    void UpdateVertex (const TopoDS_Edge& aE, 
                       const Standard_Real aT, 
                       const TopoDS_Vertex& aV);
  ...
  Standard_EXPORT static 
    void UpdateVertex (const TopoDS_Vertex& aVF, 
  ...
  Standard_EXPORT static 
    void CorrectRange (const TopoDS_Edge& aE1, 
                       const TopoDS_Edge& aE2, 
  ...
  Standard_EXPORT static 
    void CorrectRange (const TopoDS_Edge& aE, 
  ...
  Standard_EXPORT static 
    Standard_Boolean IsBlockInOnFace (const IntTools_Range& aShR, 
                                      const TopoDS_Face& aF, 
  ...
  Standard_EXPORT static 
    void CorrectShapeTolerances (const TopoDS_Shape& theS,
                                 const Standard_Boolean theRunParallel = Standard_False);
  

  //! Retutns dimension of the shape <theS>.
  Standard_EXPORT static 
    Standard_Integer Dimension (const TopoDS_Shape& theS);
  
  //! Returns true if the  shell <theShell> is open
  Standard_EXPORT static 
    Standard_Boolean IsOpenShell (const TopoDS_Shell& theShell);
  
  //! Returns true if the solid <theSolid> is inverted
  Standard_EXPORT static 
    Standard_Boolean IsInvertedSolid (const TopoDS_Solid& theSolid);
  

  //! Computes the necessary value of the tolerance for the edge
  Standard_EXPORT static 
    Standard_Boolean ComputeTolerance (const TopoDS_Face& theFace, 
                                       const TopoDS_Edge& theEdge, 
