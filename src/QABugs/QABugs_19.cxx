...
static Standard_Integer OCC27074(Draw_Interpretor& theDI, Standard_Integer theArgc, const char** theArgv)
{
  ...
  Standard_Integer aMaxCachedSpans = Draw::Atoi(theArgv[2]);
  Standard_Integer aNbValues = Draw::Atoi(theArgv[3]);

  anAdaptor.SetMaxSpansCached(aMaxCachedSpans);
...
void QABugs::Commands_19(Draw_Interpretor& theCommands) {
  ...
  theCommands.Add ("OCC27074",
                   "OCC27074 surf mc n\nCalculate value of surface n times using adaptor with mc cached spans",
