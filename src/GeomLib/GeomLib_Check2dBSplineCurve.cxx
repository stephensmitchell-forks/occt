...
void GeomLib_Check2dBSplineCurve::Init()
{
  Standard_Integer ii,
    num_poles ;
  ...
  if (( ! myCurve->IsPeriodic() )&& num_poles >= 4) {
    ...
    {
      //Around first point
      gp_Vec2d FirstVec(myFirstPnt, mySecondPnt), FirstNormVec;
    ...
    {
      //Around last point;
      gp_Vec2d LastVec(myLastPnt, myPrelastPnt), LastNormVec;
