...
public:
  ...
  Standard_EXPORT void Perform(const TopoDS_Wire& theSpine, const TopoDS_Wire& theProfile, const Standard_Boolean theSolidReq = Standard_True);
...
protected:
  ...
  Standard_EXPORT void RemoveExcessSolids(TopoDS_Shape& theShape,
