                               ...
                               const Standard_Boolean theSolidReq)
{
  ...
  if ((myErrorStatus != BRepFill_Voluved_OK) || theSolidReq)
  {
    return;
  }
...
void BRepFill_Voluved::GetLids()
{
...

  {
    ...
    for (; anExp.More(); anExp.Next())
    {
      ...
      const gp_XYZ &aNorm = aPln->Axis().Direction().XYZ();
      const gp_XYZ &aLocP = aPln->Axis().Location().XYZ();
