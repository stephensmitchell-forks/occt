...
typedef BOPCol_NCVector <FillGap> VectorOfFillGap;

typedef BOPCol_Functor <FillGap, VectorOfFillGap> FillGapFunctor;

typedef BOPCol_Cnt <FillGapFunctor, VectorOfFillGap> FillGapCnt;
...
void BOPAlgo_RemoveFeatures::UpdateHistory()
{
  ...
  // Map the result
  BOPTools::MapShapes(myShape, myResultMap);
