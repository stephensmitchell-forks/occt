...
class BOPAlgo_VertexFace : public BOPAlgo_Algo {
 public:
  ...
  BOPAlgo_VertexFace() : 
    ...
    myFlag(-1), myT1(-1.),  myT2(-1.), myTol(0.) {
  }
  //
  ...
  virtual void Perform() {
    ...
    myFlag=myContext->ComputeVF(myV, myF, myT1, myT2, myTol, myFuzzyValue);
  }
  //
 protected:
...
void BOPAlgo_PaveFiller::PerformVF()
{
  ...
  Standard_Real aT1, aT2, aTolVNew;
  ...
  if (iSize) {
    ...
    for (k=0; k < aNbVF; ++k) {
      ...
      aTolVNew = aVertexFace.Tolerance();
