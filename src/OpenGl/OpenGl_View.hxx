...
public:
  ...
  virtual const Handle(Graphic3d_ListOfCLight)& Lights() const Standard_OVERRIDE { return myLights; }

  //! Sets list of lights for the view.
  virtual void SetLights (const Handle(Graphic3d_ListOfCLight)& theLights) Standard_OVERRIDE
  {
    myLights = theLights;
...
protected:
  ...
  Handle(Graphic3d_ListOfCLight)  myNoShadingLight;
  Handle(Graphic3d_ListOfCLight)  myLights;
