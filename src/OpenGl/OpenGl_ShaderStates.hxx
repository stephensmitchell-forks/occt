...
public:
  ...
  void Set (const Handle(Graphic3d_ListOfCLight)& theLightSources) { myLightSources = theLightSources; }

  //! Returns current list of light sources.
  const Handle(Graphic3d_ListOfCLight)& LightSources() const { return myLightSources; }

private:

  Handle(Graphic3d_ListOfCLight) myLightSources; //!< List of OCCT light sources
