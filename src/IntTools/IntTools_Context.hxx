...
Standard_EXPORT virtual  ~IntTools_Context();
  ...
  Standard_EXPORT 
    Standard_Integer ComputePE (const gp_Pnt& theP, 
  ...
  //! 3. projection algorithm failed (-3)
  Standard_EXPORT 
    Standard_Integer ComputeVE (const TopoDS_Vertex& aV, 
  ...
  //! 3. projection algorithm failed (-3)
  Standard_EXPORT 
    Standard_Integer ComputeVE (const TopoDS_Vertex& theV, 
                                const TopoDS_Edge& theE, 
                                Standard_Real& theT,
  ...
  Standard_EXPORT 
    Standard_Integer ComputeVF (const TopoDS_Vertex& aV, 
  ...
  //! 3. projection point out or on the boundaries of face (-3)
  Standard_EXPORT 
    Standard_Integer ComputeVF (const TopoDS_Vertex& theVertex, 
  ...
  //! relative to face aF
  Standard_EXPORT 
    TopAbs_State StatePointFace (const TopoDS_Face& aF, 
                                 const gp_Pnt2d& aP2D);
  ...
  Standard_EXPORT 
    Standard_Boolean IsPointInFace (const TopoDS_Face& aF, 
                                    const gp_Pnt2d& aP2D);
  ...
  //! otherwise returns false
  Standard_EXPORT 
    Standard_Boolean IsPointInFace (const gp_Pnt& aP3D, 
                                    const TopoDS_Face& aF, 
  ...
  Standard_EXPORT 
    Standard_Boolean IsPointInOnFace (const TopoDS_Face& aF, 
                                      const gp_Pnt2d& aP2D);
  ...
  //! of the face aF
  Standard_EXPORT 
    Standard_Boolean IsValidPointForFace (const gp_Pnt& aP3D, 
                                          const TopoDS_Face& aF, 
                                          const Standard_Real aTol);
  ...
  Standard_EXPORT 
    Standard_Boolean IsValidPointForFaces (const gp_Pnt& aP3D, 
  ...
  Standard_EXPORT 
    Standard_Boolean IsValidBlockForFace (const Standard_Real aT1, 
  ...
  Standard_EXPORT 
    Standard_Boolean IsValidBlockForFaces (const Standard_Real aT1, 
                                           const Standard_Real aT2, 
                                           const IntTools_Curve& aIC, 
                                           const TopoDS_Face& aF1, 
                                           const TopoDS_Face& aF2, 
  ...
  Standard_EXPORT
    Standard_Boolean IsVertexOnLine (const TopoDS_Vertex& aV, 
                                     const IntTools_Curve& aIC, 
  ...
  Standard_EXPORT 
    Standard_Boolean ProjectPointOnEdge (const gp_Pnt& aP, 
                                         const TopoDS_Edge& aE, 
                                         Standard_Real& aT);
