...
public:
  ...
  //! This function is entered only for compatibility with BRepClass*.
  Standard_EXPORT Standard_Boolean CheckPoint (gp_Pnt2d& P);

  //! Returns ray to process.
  //! theMaxRating variable is entered for compatibility with
  //! BRepClass* classes and is not use here.
  Standard_EXPORT Standard_Boolean OtherRay(const gp_Pnt2d& thePnt,
