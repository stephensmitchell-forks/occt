...
namespace
{
  ...
  static bool isValidValue (Standard_Real theVal) { return theVal >= -THE_MAT_PREC && theVal <= 1.0 + THE_MAT_PREC; }
                                ...
                                (const Handle(VrmlData_Node)& theOther) const
{
  ...
  aResult->myAmbientColor =     myAmbientColor;
...
VrmlData_ErrorStatus VrmlData_Material::Read (VrmlData_InBuffer& theBuffer)
{
  ...
  if (OK(aStatus)) {
    ...
    myAmbientColor.SetValues  (aColor[0].X(), aColor[0].Y(), aColor[0].Z(), Quantity_TOC_RGB);
    myDiffuseColor.SetValues  (aColor[1].X(), aColor[1].Y(), aColor[1].Z(), Quantity_TOC_RGB);
    myEmissiveColor.SetValues (aColor[2].X(), aColor[2].Y(), aColor[2].Z(), Quantity_TOC_RGB);
    mySpecularColor.SetValues (aColor[3].X(), aColor[3].Y(), aColor[3].Z(), Quantity_TOC_RGB);
  }
  return aStatus;
}
