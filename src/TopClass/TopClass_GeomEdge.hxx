...
public:
  ...
  //! the 3D-curve myC3D to thePt. If (thePntOnC != 0)
  //! the found value will be assigned to thePntOnC.
  //! If (theParOnC != 0) the method will assign to it the
  //! parameter on myC3D respected to thePntOnC.
  ...
  //! Looks for thePntOnC, which is nearest point in
  //! the 2D-curve myC2D to thePt. If thePntOnC != 0
  //! the found value will be assigned to thePntOnC.
  //! If (theParOnC != 0) the method will assign to it the
