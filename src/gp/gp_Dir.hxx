...
public:
  ...
  Standard_Boolean IsCoincide ( const gp_Dir& theOther,
  ...
  Standard_EXPORT Standard_Real AngleWithRef (const gp_Dir& theOther,
                                              const gp_Dir& theVref) const
  {
    const gp_XYZ aNormal(coord.Crossed (theOther.coord));
    return Sign(Angle(theOther), aNormal.Dot(theVref.coord));
  }
