                                                          ...
                                                          const Standard_Boolean          theDirectionFlag) 
{
  ...
  if (Abs(Param(1) - UFirst1) < ResoU1)
  {
    return bOutOfTangentZone;
  }
  else if (Abs(Param(2) - VFirst1) < ResoV1)
  {
    return bOutOfTangentZone;
  }
  else if (Abs(Param(3) - UFirst2) < ResoU2)
  {
    return bOutOfTangentZone;
  }
  else if (Abs(Param(4) - VFirst2) < ResoV2)
  {
    return bOutOfTangentZone;
  }

  if (Abs(Param(1) - ULast1) < ResoU1)
  {
    return bOutOfTangentZone;
  }
  else if (Abs(Param(2) - VLast1) < ResoV1)
  {
    return bOutOfTangentZone;
  }
  else if (Abs(Param(3) - ULast2) < ResoU2)
  {
    return bOutOfTangentZone;
  }
  else if (Abs(Param(4) - VLast2) < ResoV2)
  {
    return bOutOfTangentZone;
  }
