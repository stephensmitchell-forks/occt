     ...
     
{
  ...
  if (chsp->IsChamfer() == ChFiDS_Sym) {
    ...
    {
      Func = new BRepBlend_ConstThroat(S1,S2,HGuide);
      FInv = new BRepBlend_ConstThroatInv(S1,S2,HGuide); 
    }
    ...
    else
    {
      ...
      Func = new BRepBlend_ConstThroatWithPenetration(S1,S2,OffsetHGuide);
      FInv = new BRepBlend_ConstThroatWithPenetrationInv(S1,S2,OffsetHGuide);
      Standard_Real Throat = Max(dis1,dis2);
      Func->Set(Throat,Throat,Choix);
      FInv->Set(Throat,Throat,Choix);
    }
