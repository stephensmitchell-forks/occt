                                     ...
                                     const bool                             theToOverrideDefaults)
{
  switch (theAspect)
  {
    case Graphic3d_ASPECT_LINE:
    {
      ...
      if (myHasOwnDatumAspect)
      {
        setAspectProgram (theProgram, true, myDatumAspect->FirstAxisAspect());
        setAspectProgram (theProgram, true, myDatumAspect->SecondAxisAspect());
        setAspectProgram (theProgram, true, myDatumAspect->ThirdAxisAspect());
      }
